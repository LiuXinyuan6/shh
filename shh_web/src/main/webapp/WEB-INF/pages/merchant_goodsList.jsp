                        ...
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-refresh" onclick="javascript:window.location.href='/merchant/list_goods';"></i>
                                </button>
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-trash"></i>
                                </button>
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-plus" onclick="javascript:window.location.href='/merchant/to_AddGoods';"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${list}" var="goods">
                            <tr class="message-unread">
                                ...
                                <td>${goods.phone}</td>
                                <td>
                                    <a href="/merchant/to_update?id_goods=${goods.id_goods}">编辑</a>
                                    <a href="/merchant/remove?id_goods=${goods.id_goods}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
