    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form action="/goods/add" modelAttribute="goods"  id="admin-form" name="addForm">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="id_merchant" class="field prepend-icon">
                                    <form:select path="id_merchant" class="gui-input" items="${list}" itemLabel="id" itemValue="id"/>
                                    <label for="id_merchant" class="field-icon">
                                        <i class="fa fa-user"></i>
                                    </label>
                                </label>
                            </div>
